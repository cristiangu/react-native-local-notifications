...
@implementation CoreDelegateHolder {
  struct {
...
+ (instancetype)instance {
  ...
  __strong static CoreDelegateHolder *sharedInstance;
  dispatch_once(&once, ^{
    sharedInstance = [[CoreDelegateHolder alloc] init];
    sharedInstance.pendingEvents = [[NSMutableArray alloc] init];
  });
  return sharedInstance;
}

- (void)setDelegate:(id<CoreDelegate>)aDelegate {
